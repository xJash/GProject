...
public:
	...
	void CreateFactory(  ITZSessionManager *pSessionManager, int maxsize, SI32 siRecvBufSize, SI32 siSendBufSize, SI32 headerType = 0 )
	{
		...
		for( int i = 0; i < maxsize; ++i ) {
			...
			pSession->SetBuffer( siRecvBufSize, siSendBufSize, headerType );
