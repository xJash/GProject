...
void ITZSendBuffer::CreateSendBuffer( SI32 size, SI32 headerType )
{
...
BOOL ITZSendBuffer::GetSendParam( char **pSendPtr, SI32 *psiDataLen )
{
	EnterCriticalSection( &m_cs );
...
BOOL ITZSendBuffer::Write( char *pPacket )
{
