...
void NDraw::PutSpr16T( UI08 *pSrcImage, int x, int y, int width, int height )
{
	...
	psrc = pSrcImage;
	pdest = (RGB16 *)( m_pTargetBuffer + ( y * iPitch ) + x );
	
	pColorTable = (RGB16 *)m_pColorTable;
...
void NDraw::PutSpr16RT( UI08 *pSrcImage, int x, int y, int width, int height )
{
...
void NDraw::PutSpr16CT( UI08 *pSrcImage, int x, int y, int width, int height )
{
	...
	if( pDestImage ) pdest = (RGB16 *)pDestImage + ( y * iPitch ) + x;
	else pdest = (RGB16 *)m_pImage + ( y * iPitch ) + x;
...
void NDraw::PutSpr16CRT( UI08 *pSrcImage, int x, int y, int width, int height )
{
