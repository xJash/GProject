...
BOOL CALLBACK cltCharStatus::CharStatusQuestStaticProc(HWND hDlg, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
...
BOOL CALLBACK cltCharStatus::CharStatusQuestProc(HWND hDlg, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	SI32 id = 1;
	char buffer[256]="";
