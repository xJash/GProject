#include "MagicCurseDefenseObj.h"
...
CMagicCurseDefenseObj::CMagicCurseDefenseObj( CMagicMgr *pMagicMgr ) : CMagicBaseObj( pMagicMgr )
{
...
CMagicCurseDefenseObj::~CMagicCurseDefenseObj()
{
	Destroy();
}

void CMagicCurseDefenseObj::Initialize()
{
...
void CMagicCurseDefenseObj::Destroy()
{
	if ( m_pMagicInfo )
	{
		delete m_pMagicInfo;
...
bool CMagicCurseDefenseObj::SetMagic( stMagicInfo *pstMagicInfo, SI32 si32AddDamage, cltMapCommon *pclMap, SI32 si32SkillLevel, SI32 siOrganUnique )
{
...
// 디레이 주의 할것
bool CMagicCurseDefenseObj::Action()
{	
	...
	pclClient->pclBulletManager->SetBullet( m_pclMap, BULLETKIND_MAGICCURSEDEFENSE, GetKind()
		, Fromid
...
void CMagicCurseDefenseObj::Draw( )
{	
...
// Push
bool CMagicCurseDefenseObj::Push( BYTE *pData, SI32 si32Size )
{
