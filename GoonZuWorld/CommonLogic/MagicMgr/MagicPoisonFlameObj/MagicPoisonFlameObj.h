#ifndef _MAGICPOISONFLAMEOBJ_H_
#define _MAGICPOISONFLAMEOBJ_H_
...
class CMagicPoisonFlameObj : public CMagicBaseObj
{
public:
	CMagicPoisonFlameObj( CMagicMgr *pMagicMgr );
	~CMagicPoisonFlameObj();
