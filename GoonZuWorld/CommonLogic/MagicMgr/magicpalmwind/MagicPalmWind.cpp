...
CMagicPalmWindObj::CMagicPalmWindObj( CMagicMgr *pMagicMgr ) : CMagicBaseObj( pMagicMgr )
{
...
CMagicPalmWindObj::~CMagicPalmWindObj()
{
	Destroy();
}

void CMagicPalmWindObj::Initialize()
{
...
void CMagicPalmWindObj::Destroy()
{
	if ( m_pMagicInfo )
	{
		delete m_pMagicInfo;
...
bool CMagicPalmWindObj::SetMagic( stMagicInfo *pstMagicInfo, SI32 si32AddDamage, cltMapCommon *pclMap, SI32 si32SkillLevel, SI32 siOrganUnique )
{
...
{	
	...
	*/
	...
	pclClient->pclBulletManager->SetBullet( m_pclMap, BULETKIND_MAGICPALMWIND, GetKind()
		, Fromid
...
// Push
bool CMagicPalmWindObj::Push( BYTE *pData, SI32 si32Size )
{
