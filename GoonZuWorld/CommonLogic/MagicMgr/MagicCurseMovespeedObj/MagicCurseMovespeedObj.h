#ifndef  _MAGICCURSEMOVESPEEDOBJ_H_
#define  _MAGICCURSEMOVESPEEDOBJ_H_
...
class	CMagicCurseMovespeedObj : public CMagicBaseObj
{
public:
	CMagicCurseMovespeedObj( CMagicMgr *pMagicMgr );
	~CMagicCurseMovespeedObj();
