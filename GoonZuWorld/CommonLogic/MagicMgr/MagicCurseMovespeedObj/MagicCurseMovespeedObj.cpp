#include "MagicCurseMovespeedObj.h"
...
CMagicCurseMovespeedObj::CMagicCurseMovespeedObj( CMagicMgr *pMagicMgr ) : CMagicBaseObj( pMagicMgr )
{
...
CMagicCurseMovespeedObj::~CMagicCurseMovespeedObj()
{
	Destroy();
}

void CMagicCurseMovespeedObj::Initialize()
{
...
void CMagicCurseMovespeedObj::Destroy()
{
	if ( m_pMagicInfo )
	{
		delete m_pMagicInfo;
...
bool CMagicCurseMovespeedObj::SetMagic( stMagicInfo *pstMagicInfo, SI32 si32AddDamage, cltMapCommon *pclMap, SI32 si32SkillLevel, SI32 siOrganUnique )
{
...
// 디레이 주의 할것
bool CMagicCurseMovespeedObj::Action()
{	
	...
	pclClient->pclBulletManager->SetBullet( m_pclMap, BULLETKIND_MAGICCURSEMOVESPEED, GetKind()
		, Fromid
...
void CMagicCurseMovespeedObj::Draw( )
{	
...
// Push
bool CMagicCurseMovespeedObj::Push( BYTE *pData, SI32 si32Size )
{
