#ifndef _MAGICDROPSNOWMANOBJ_H_
#define _MAGICDROPSNOWMANOBJ_H_
...
class CMagicDropSnowmanObj : public CMagicBaseObj
{
public:
	CMagicDropSnowmanObj( CMagicMgr *pMagicMgr );
	~CMagicDropSnowmanObj();
