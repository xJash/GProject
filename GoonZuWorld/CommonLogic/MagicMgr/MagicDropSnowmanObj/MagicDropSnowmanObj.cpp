...
CMagicDropSnowmanObj::CMagicDropSnowmanObj( CMagicMgr *pMagicMgr ) : CMagicBaseObj( pMagicMgr )
{
...
CMagicDropSnowmanObj::~CMagicDropSnowmanObj()
{
	Destroy();
}

void CMagicDropSnowmanObj::Initialize()
{
...
void CMagicDropSnowmanObj::Destroy()
{
	if ( m_pMagicInfo )
	{
		delete m_pMagicInfo;
...
bool CMagicDropSnowmanObj::SetMagic( stMagicInfo *pstMagicInfo, SI32 si32AddDamage, cltMapCommon *pclMap, SI32 si32SkillLevel, SI32 siOrganUnique )
{
...
// 디레이 주의 할것
bool CMagicDropSnowmanObj::Action()
{	
...
void CMagicDropSnowmanObj::Draw( )
{	
	...
	SetMagicSpr( GIMG_MAGIC_DROPSNOWMAN);				// Image index
...
// Push
bool CMagicDropSnowmanObj::Push( BYTE *pData, SI32 si32Size )
{
...
void CMagicDropSnowmanObj::SetDamage( SI32 si32Damage )
{
