#include "MagicLightingFistObj.h"
...
CMagicLightingFistObj::CMagicLightingFistObj( CMagicMgr *pMagicMgr ) : CMagicBaseObj( pMagicMgr )
{
...
CMagicLightingFistObj::~CMagicLightingFistObj()
{
	Destroy();
}

void CMagicLightingFistObj::Initialize()
{
...
void CMagicLightingFistObj::Destroy()
{
	if ( m_pMagicInfo )
	{
		delete m_pMagicInfo;
...
bool CMagicLightingFistObj::SetMagic( stMagicInfo *pstMagicInfo, SI32 si32AddDamage, cltMapCommon *pclMap, SI32 si32SkillLevel, SI32 siOrganUnique )
{
...
// 디레이 주의 할것
bool CMagicLightingFistObj::Action()
{	
	...
	pclClient->pclBulletManager->SetBullet( m_pclMap, BULLETKIND_MAGICLIGHTINGFIST, GetKind()
		, Fromid
...
void CMagicLightingFistObj::Draw( )
{	
...
// Push
bool CMagicLightingFistObj::Push( BYTE *pData, SI32 si32Size )
{
