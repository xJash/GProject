...
CMagicDropMoneyObj::CMagicDropMoneyObj( CMagicMgr *pMagicMgr ) : CMagicBaseObj( pMagicMgr )
{
...
CMagicDropMoneyObj::~CMagicDropMoneyObj()
{
	Destroy();
}

void CMagicDropMoneyObj::Initialize()
{
...
void CMagicDropMoneyObj::Destroy()
{
	if ( m_pMagicInfo )
	{
		delete m_pMagicInfo;
...
bool CMagicDropMoneyObj::SetMagic( stMagicInfo *pstMagicInfo, SI32 si32AddDamage, cltMapCommon *pclMap, SI32 si32SkillLevel, SI32 siOrganUnique )
{
...
// 디레이 주의 할것
bool CMagicDropMoneyObj::Action()
{	
...
{	
	...
	SetMagicSpr( GIMG_MAGIC_DROPMONEY);				// Image index
...
// Push
bool CMagicDropMoneyObj::Push( BYTE *pData, SI32 si32Size )
{
...
void CMagicDropMoneyObj::SetDamage( SI32 si32Damage )
{
