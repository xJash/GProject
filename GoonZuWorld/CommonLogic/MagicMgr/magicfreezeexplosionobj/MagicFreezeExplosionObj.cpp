#include "MagicFreezeExplosionObj.h"
...
CMagicFreezeExplosionObj::CMagicFreezeExplosionObj( CMagicMgr *pMagicMgr ) : CMagicBaseObj( pMagicMgr )
{
...
CMagicFreezeExplosionObj::~CMagicFreezeExplosionObj()
{
	Destroy();
}

void CMagicFreezeExplosionObj::Initialize()
{
...
void CMagicFreezeExplosionObj::Destroy()
{
	if ( m_pMagicInfo )
	{
		delete m_pMagicInfo;
...
bool CMagicFreezeExplosionObj::SetMagic( stMagicInfo *pstMagicInfo, SI32 si32AddDamage, cltMapCommon *pclMap, SI32 si32SkillLevel, SI32 siOrganUnique )
{
...
// 디레이 주의 할것
bool CMagicFreezeExplosionObj::Action()
{	
	...
	pclClient->pclBulletManager->SetBullet( m_pclMap, BULLETKIND_CANNON_MAGIC, GetKind()
		, Fromid
...
void CMagicFreezeExplosionObj::Draw( )
{	
...
// Push
bool CMagicFreezeExplosionObj::Push( BYTE *pData, SI32 si32Size )
{
