...
void NGraphics::PutSpr16T( int x, int y, UI08 *pSrcImage, int width, int height, UI08 *pDestImage )
{
...
void NGraphics::PutSpr16RT( int x, int y, UI08 *pSrcImage, int width, int height, UI08 *pDestImage )
{
...
void NGraphics::PutSpr16CT( int x, int y, UI08 *pSrcImage, int width, int height, UI08 *pDestImage )
{
...
void NGraphics::PutSpr16CRT( int x, int y, UI08 *pSrcImage, int width, int height, UI08 *pDestImage )
{
...
BYTE NGraphics::GetSpr16T( int x, int y, int width, int height, UI08 *pImage )
{
	int i, j;
...
BYTE NGraphics::GetSpr16RT( int x, int y, int width, int height, UI08 *pImage )
{
	int i, j;
