...
void NGraphics::PutSpr16AT( int x, int y, UI08 *pSrcImage, int width, int height, int alpha, UI08 *pDestImage )
{
	...
	for( i = 0; i < height; ++i ) {
		...
		while( j < width ) {
			...
			if( *psrc == COLOR_TRANS ) {
				...
				pdest[ j ] = pSrcAlphaTable[ pColorTable[ *psrc ] ] +
							 pDestAlphaTable[ pdest[ j ] ];
				++psrc;
				++j;
			}
		}
...
void NGraphics::PutSpr16RAT( int x, int y, UI08 *pSrcImage, int width, int height, int alpha, UI08 *pDestImage )
{
...
void NGraphics::PutSpr16CAT( int x, int y, UI08 *pSrcImage, int width, int height, int alpha, UI08 *pDestImage )
{
...
void NGraphics::PutSpr16CRAT( int x, int y, UI08 *pSrcImage, int width, int height, int alpha, UI08 *pDestImage )
{
