...
HANREPORT_API int __stdcall HanReportInitWithPl2( /*IN*/ char* szGameId, 
												 /*IN*/ char* szXmlFilePath, 
												 /*IN*/ bool bSendDump=true );

HANREPORT_API int __stdcall HanReportInitGameStringWithPl2(/*IN*/ char* szGameString, 
														   /*IN*/ char* szXmlFilePath,  
														   /*IN*/ bool bSendDump=true );
