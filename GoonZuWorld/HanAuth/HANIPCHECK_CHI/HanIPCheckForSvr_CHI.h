...
HANIPCHECK_API int __stdcall 
HanIPCheckInit(IN const char* szGameId);

HANIPCHECK_API int __stdcall 
HanIPCheckRequest(IN OUT char* szRstStrBuff, IN int nRstStrBuffSize, IN const char* szIP);

HANIPCHECK_API int __stdcall 
HanIPCheckGetLastError();

HANIPCHECK_API const char* __stdcall 
HanIPCheckErrorString(IN int nErrorCode);

HANIPCHECK_API void __stdcall 
HanIPCheckTerm();

HANIPCHECK_API int __stdcall 
HanIPCheckRequestEx(IN OUT char* szRstStrBuff, IN int nRstStrBuffSize, IN const char* szIP, IN const char* szParam);
