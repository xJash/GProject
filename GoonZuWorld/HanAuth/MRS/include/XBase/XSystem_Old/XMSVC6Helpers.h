...
// Added VoidWrap
// Added qualification Private:: to types from the Private-Namespace
// Thanks to Adi Shavit

#ifndef MSVC6HELPERS_Old__H
#define MSVC6HELPERS_Old__H
...
////////////////////////////////////////////////////////////////////////////////
		...
		struct ApplyImpl1
		{
			...
			template<> struct VC_WORKAROUND<true>
			{	template<class> struct In; };

			template< typename T1 > struct Result : public
				VC_WORKAROUND< ::XMSVC6::Private::AlwaysFalse<TypeWithNestedTemplate>::value >::template In<T1>
			{
				typedef VC_WORKAROUND< ::XMSVC6::Private::AlwaysFalse<TypeWithNestedTemplate>::value >::template In<T1> Base;
...
////////////////////////////////////////////////////////////////////////////////
		...
		struct ApplyImpl2
		{
			...
			VC_WORKAROUND< ::XMSVC6::Private::AlwaysFalse<TypeWithNestedTemplate>::value >::template In<T1, T2>
			{
			};
		};
...
////////////////////////////////////////////////////////////////////////////////
	...
	struct Apply1 : ::XMSVC6::Private::ApplyImpl1<F>::template Result<T1>
	{
		typedef typename ::XMSVC6::Private::ApplyImpl1<F>::template Result<T1>::Base Base;
	};
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
	...
	struct Apply2 : ::XMSVC6::Private::ApplyImpl2<F>::template Result<T1, T2>
	{
...
////////////////////////////////////////////////////////////////////////////////
	...
	struct ApplyInnerType
	{
		...
		typedef typename
		Wrapper_VC< ::XMSVC6::Private::AlwaysFalse<Wrapper>::value>::template In<T>::type type;
	};
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
	...
	struct ApplyInnerType2
	{
		...
		typedef typename
		Wrapper_VC< ::XMSVC6::Private::AlwaysFalse<Wrapper>::value>::template In<T, V>::type type;
	};
	...
	struct ApplyInnerType4
	{
		...
		typedef typename
		Wrapper_VC< ::XMSVC6::Private::AlwaysFalse<Wrapper>::value>::template In<T, U, V, W>::type type;
	};

}	// end of namespace XMSVC6
