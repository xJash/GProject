#ifndef _HORSEINVENTORYDLG_H_
#define _HORSEINVENTORYDLG_H_
...
public:
	...
	static BOOL CALLBACK StaticHorseInventoryDlgProc(HWND hDlg, UINT iMsg, WPARAM wParam, LPARAM lParam);
	BOOL CALLBACK HorseInventoryDlgProc(HWND hDlg, UINT iMsg, WPARAM wParam, LPARAM lParam);
