...
NStrResignChiefDlg::NStrResignChiefDlg()
{
}
...
void NStrResignChiefDlg::InitDlg()
{
	SetControlMap( BUTTON_RESIGN, TEXT("button_resign") );
}

void NStrResignChiefDlg::NDlgTabProc( UINT nEvent, int nControlID, CControllerObj *pControl )
{
