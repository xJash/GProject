...
NHorseMarketChiefDlg::NHorseMarketChiefDlg()
{
}
...
void NHorseMarketChiefDlg::InitDlg()
{
...
void NHorseMarketChiefDlg::NDlgTabProc( UINT nEvent, int nControlID, CControllerObj *pControl )
{
	...
	CASE_CONTROL( BUTTON_SETFEERATE )
	{
		...
		cltGameMsgRequest_HorseMarketSetFee setfee;
		...
		if( setfee.clFee.SetFeeRate( (SI32)(minfee * 10) ) == TRUE ) {
			...
			cltMsg clMsg( GAMEMSG_REQUEST_HORSEMARKET_SETFEE, sizeof( setfee ), (BYTE *)&setfee );
