...
void NStockChiefDlg::NDlgTabProc( UINT nEvent, int nControlID, CControllerObj *pControl )
{
	...
	CASE_CONTROL( BUTTON_SETFEERATE )
	{
		...
		if( clFee.SetFeeRate((SI32)(minfee*10)) == TRUE)
		{
			...
			// 서버로 수수료 변경 요청을 한다. 
			cltMsg clMsg(GAMEMSG_REQUEST_SETSTOCKFEE,  
