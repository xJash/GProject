...
public:
	...
	bool GetRegistryPath( CString& rstrRegistryPath );
	bool MakeRegistryInfo( void );
...
// Dialog Data
	...
	CWebBrowser2	m_WebBrowserRight;
	CWebBrowser2	m_WebBrowserLeft;
	//}}AFX_DATA
