// MapTileDiv.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CMapTileDivApp, CWinApp)
...
// 유일한 CMapTileDivApp 개체입니다.

CMapTileDivApp theApp;


// CMapTileDivApp 초기화

BOOL CMapTileDivApp::InitInstance()
{
