...
public:
    ...
    BOOL		CreateFullScreenGraphics( HWND hWnd, DWORD dwWidth, DWORD dwHeight, DWORD dwBPP, DWORD dwBackXSize = 0, DWORD dwBackYSize = 0);
	...
	BOOL		LoadXpr( char *filename, XSpr *pXSpr );
