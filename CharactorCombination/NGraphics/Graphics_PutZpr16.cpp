...
void NGraphics::PutZpr16T( int x, int y, UI08 *pSrcImage, int width, int height, UI08 *pDestImage )
{
...
void NGraphics::PutZpr16CT( int x, int y, UI08 *pSrcImage, int width, int height, UI08 *pDestImage )
{
