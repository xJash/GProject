...
void CStdGrfx::drawFrame( CDC* dc, CRect rect )
/* ============================================================
	Function :		CStdGrfx::draw3dFrame
	Description :	Draws a 3d rect.
...
/**
leon add
* todo - new property drawing fuction
*/
void CStdGrfx::drawbufferDC( CDC* dc, CRect rect, CDC* pbufferDC, double zoom )
{
	...
	/**
	leon add
	* todo - 확대 기능 없이 출력할때 사용
	*/
	//dc->BitBlt(rect.left, rect.top, rect.Width(), rect.Height(), pbufferDC, 0, 0, SRCCOPY );
	...
	*/
	...
	dc->StretchBlt(rect.left, rect.top, width, height, pbufferDC, 0, 0, width/zoom, height/zoom, SRCCOPY );
	//dc->StretchBlt(rect.left, rect.top, width, height, pbufferDC, 0, 0, width/zoom, height/zoom, SRCCOPY );
